...
RSpec.shared_context("with dependabot helper") do
  ...
  let(:vulnerability) do
    Vulnerability.new(
      ...
      first_patched_version: "1.13.4",
      id: 14_819,
      identifiers: ["GHSA-v6gp-9mmm-c6p5"],
      origin: "UNSPECIFIED",
      package: "nokogiri",
      package_ecosystem: "bundler",
      package_manager: "bundler",
      permalink: "https://github.com/advisories/GHSA-v6gp-9mmm-c6p5",
      published_at: "2022-04-11T21:21:28.000+00:00",
      severity: "HIGH",
      summary: "Out-of-bounds Write in zlib affects Nokogiri",
      vulnerable_version_range: "< 1.13.4",
      references: [
