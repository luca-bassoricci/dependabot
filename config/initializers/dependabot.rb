...
# rubocop:disable Metrics/MethodLength, Metrics/ParameterLists, Metrics/BlockLength

# Patch MR creation and update to support MR's against forks
#

Dependabot::PullRequestCreator.class_eval do
...
Dependabot::PullRequestCreator::Gitlab.class_eval do
  attr_reader :target_project_id
...
Dependabot::PullRequestUpdater.class_eval do
  attr_reader :target_project_id
...
Dependabot::PullRequestUpdater::Gitlab.class_eval do
  attr_reader :target_project_id
...
# rubocop:enable Metrics/MethodLength, Metrics/ParameterLists, Metrics/BlockLength
