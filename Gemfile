...
gem "dependabot-omnibus", "~> 0.152.0"
...
gem "sentry-rails", "~> 4.5", require: false
gem "sentry-ruby", "~> 4.5", require: false
gem "sentry-sidekiq", "~> 4.5", require: false
gem "sidekiq", "~> 6.2.1"
...
group :development do
  ...
  gem "solargraph", "~> 0.42.1", require: false
